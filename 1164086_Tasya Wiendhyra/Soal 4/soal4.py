...
w=shapefile.Writer(shapefile.POINTM) #mendeklarasikan file shapefile yang baru dengan format daa multiple point
...
w.save("soal4") #yang berada didalam kurung merupakn nama file yang telah/akan di save
